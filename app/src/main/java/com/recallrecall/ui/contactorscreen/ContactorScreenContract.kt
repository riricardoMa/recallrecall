...
/**
 * ContactorScreen Actions emitted from the UI Layer
 ...
 **/
val LocalContactorScreenActions = staticCompositionLocalOf<ContactorScreenActions> {
...
fun ProvideContactorScreenActions(
  ...
  CompositionLocalProvider(LocalContactorScreenActions provides actions) {
    content.invoke()
  }
}
